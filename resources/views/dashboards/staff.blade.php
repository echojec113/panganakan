...
<style>
    ...
    /* Override Tailwind bg-blue-50 for kpi-blue card */
    .kpi-card.kpi-blue .kpi-icon { background: #d1f9e6 !important; }
    ...
    .avatar {
        ...
        background: #eff6ff; color: #55B85A;
    }
    ...
    .badge-blue   { background: #d1f9e6; color: #059669; border: 1px solid #86efac; }
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <div class="flex items-center gap-2 mb-0.5">
                        <div class="w-2 h-2 rounded-full bg-[#55B85A] animate-pulse"></div>
                        <span class="text-xs font-semibold text-[#19355F] tracking-widest uppercase">Daily Operations</span>
                    </div>
