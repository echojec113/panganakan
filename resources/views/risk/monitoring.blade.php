<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <div class="rounded-xl shadow-sm border border-gray-100 overflow-hidden" style="border-left: 4px solid #dc2626;">
                <div class="p-4 sm:p-5 bg-white">
                    ...
                    <a href="{{ route('risk.monitoring', ['risk_filter' => 'HIGH']) }}#patient-assessments" class="inline-block mt-2 text-xs font-semibold text-red-600 hover:text-red-800 underline">View HIGH &rarr;</a>
                </div>
            </div>

            <!-- Low Risk Card -->
            <div class="rounded-xl shadow-sm border border-gray-100 overflow-hidden" style="border-left: 4px solid #16a34a;">
                <div class="p-4 sm:p-5 bg-white">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="{{ route('risk.monitoring', ['risk_filter' => 'LOW']) }}#patient-assessments" class="inline-block mt-2 text-xs font-semibold text-green-600 hover:text-green-800 underline">View LOW &rarr;</a>
                </div>
            </div>
            ...
            <div class="border-b border-gray-100 px-4 sm:px-6 py-4 bg-gray-50">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <select id="riskAnalyticsType" class="px-4 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                        ...
                        <select id="riskAnalyticsMonth" class="px-4 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-3 sm:p-4 mb-6">
            <form method="GET" class="flex flex-col sm:flex-row gap-3">
                <div class="flex-1">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="search"
                            ...
                            class="w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                    </div>
                </div>

                <div class="sm:w-40 lg:w-44">
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">Risk Level</label>
                    <select name="risk_filter" class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                ...
                <div class="sm:w-44 lg:w-48">
                    ...
                    <select name="decision_source" class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                ...
                <div class="sm:w-40 lg:w-44">
                    ...
                    <select name="urgency" class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                ...
                <div class="sm:w-44 lg:w-48">
                    ...
                    <select name="bp_verification_status" class="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                ...
                <div class="flex gap-2 items-end">
                    <button type="submit"
                        class="flex-1 sm:flex-none px-4 sm:px-6 py-2 bg-[#55B85A] text-white rounded-lg hover:bg-[#4aa04c] transition font-medium text-sm">
                        Apply
                    </button>
                    @if(request('search') || request('risk_filter') || request('decision_source') || request('urgency') || request('bp_verification_status'))
                        <a href="{{ route('risk.monitoring') }}" 
                            class="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition text-sm text-center">
                            Clear
                        </a>
                    @endif
                </div>
        ...
        <div id="patient-assessments" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden scroll-mt-20">
            <div class="border-b border-gray-100 px-4 sm:px-6 py-4 bg-gray-50">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="p-4 border-b border-gray-100 hover:bg-gray-50">
                    <div class="flex items-start justify-between mb-2">
                        <div class="flex items-center gap-3 min-w-0 flex-1">
                            <div class="h-10 w-10 rounded-full bg-[#FCFBF8] border border-slate-200 flex items-center justify-center flex-shrink-0">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div class="h-10 w-10 rounded-full bg-[#FCFBF8] border border-slate-200 flex items-center justify-center">
                                            <span class="text-gray-700 font-medium text-sm">
                                                {{ strtoupper(substr($visit->patient->first_name, 0, 1)) }}{{ strtoupper(substr($visit->patient->last_name, 0, 1)) }}
                                            </span>
                                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Smooth-scroll to the Patient Assessments list when a quick filter
        // (View HIGH / View LOW / View Incomplete) was applied. The double
        // requestAnimationFrame lets the initial layout settle before scrolling.
        if (window.location.hash === '#patient-assessments') {
            const patientAssessments = document.getElementById('patient-assessments');
            if (patientAssessments) {
                requestAnimationFrame(() => {
                    requestAnimationFrame(() => {
                        patientAssessments.scrollIntoView({ behavior: 'smooth', block: 'start' });
                    });
                });
            }
        }
