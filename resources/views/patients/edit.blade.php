<x-app-layout>
    <style>
        .edit-patient-theme {
            ...
            --edit-soft: #EDF5EC;
            --edit-page: #FCFBF8;
            --edit-surface-muted: #F6F4EE;
            --edit-border: #E7E9E5;
            --edit-border-strong: #D1D5DB;
            --edit-text: #19355F;
            --edit-muted: #657083;
        }

        .edit-patient-theme [class~="text-blue-600"],
        .edit-patient-theme [class~="text-blue-700"] {
            color: var(--edit-primary);
        }

        .edit-patient-theme [class~="hover:text-blue-600"]:hover {
            color: var(--edit-primary-hover);
        }

        .edit-patient-theme [class~="focus:ring-blue-500"] {
            --tw-ring-color: var(--edit-primary);
        }

        .edit-patient-theme [class~="focus:border-blue-500"]:focus {
            border-color: var(--edit-primary);
        }

        .edit-patient-theme [class~="bg-gray-50"] {
            background-color: var(--edit-surface-muted);
        }

        .edit-patient-theme [class~="bg-gray-100"] {
            background-color: var(--edit-surface-muted);
        }

        .edit-patient-theme [class~="border-gray-100"],
        .edit-patient-theme [class~="border-gray-200"],
        .edit-patient-theme [class~="border-gray-300"] {
            border-color: var(--edit-border);
        }

        .edit-patient-theme [class~="text-gray-800"],
        .edit-patient-theme [class~="text-gray-700"] {
            color: var(--edit-text);
        }

        .edit-patient-theme [class~="text-gray-600"],
        .edit-patient-theme [class~="text-gray-500"],
        .edit-patient-theme [class~="text-gray-400"] {
            color: var(--edit-muted);
        }

        .edit-patient-theme [class~="from-yellow-500"] {
            background-image: none;
            background-color: var(--edit-primary);
        }

        .edit-patient-theme [class~="hover:from-yellow-600"]:hover {
            background-image: none;
    ...
    <div class="edit-patient-theme max-w-5xl mx-auto mt-8 px-4 sm:px-6 lg:px-8" style="background-color: #FCFBF8;">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gray-50 border-b border-gray-100 px-6 py-5">
                <x-icon-title title="Edit Patient" subtitle="Updating record for {{ $patient->first_name }} {{ $patient->last_name }}">
                    <x-slot name="icon">
