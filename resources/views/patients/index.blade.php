        ...
        <x-app-header class="mb-8">
            ...
            <x-slot name="actions">
                ...
                <a href="{{ route('patients.create') }}"
                        class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#55B85A] text-white text-sm font-medium hover:bg-[#4aa04c] transition shadow-sm">
...
<div class="mb-4 flex gap-2">
            <a href="{{ route('patients.index', ['filter' => 'all']) }}"
               class="px-4 py-2 text-sm font-medium rounded-lg transition {{ request('filter') !== 'my' ? 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50' : 'bg-[#55B85A] text-white shadow-sm' }}">
                All Patients
            </a>
            <a href="{{ route('patients.index', ['filter' => 'my']) }}"
               class="px-4 py-2 text-sm font-medium rounded-lg transition {{ request('filter') === 'my' ? 'bg-[#55B85A] text-white shadow-sm' : 'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50' }}">
                My Patients
            </a>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm" id="patientTable">
                    ...
                    <tbody class="divide-y divide-gray-50" id="patientTableBody">
                        ...
                        <tr class="hover:bg-gray-50/40 transition patient-row">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-full bg-[#FCFBF8] border border-slate-200 flex items-center justify-center text-xs font-bold flex-shrink-0">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center gap-1 text-gray-700">
                                    <span class="font-semibold text-slate-700">G{{ $patient->gravida }}</span>
                            ...
                            <td class="px-6 py-4">
                                <x-action-buttons 
                                         :viewRoute="route('patients.show', $patient->id)"
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <a href="{{ route('patients.create') }}" class="text-[#55B85A] text-sm hover:underline">Add your first patient</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
