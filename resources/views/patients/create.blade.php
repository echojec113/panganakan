    ...
    <div class="min-h-screen bg-[#FCFBF8]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <x-app-header class="mb-8">
                <x-slot name="title">Add New Patient</x-slot>
                <x-slot name="subtitle">Enter the patient's information below to create a new record.</x-slot>
                <x-slot name="actions">
                ...
                <form action="{{ route('patients.store') }}" method="POST" id="patientForm" class="p-6">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-2 mb-4 pb-2 border-b border-gray-100">
                            <svg class="w-5 h-5 text-[#55B85A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="first_name" 
                                    ...
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('first_name') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <input type="text" name="last_name" 
                                    ...
                                    pattern="[a-zA-Z\s]+"
                                    title="Only letters and spaces are allowed"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('last_name') border-red-500 @enderror"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="date" id="birthdate" name="birthdate"
                                    value="{{ old('birthdate') }}"
                                    max="{{ date('Y-m-d') }}"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('birthdate') border-red-500 @enderror">
                                <span class="error-message text-red-500 text-xs mt-1 hidden"></span>
                            ...
                            <div>
                                ...
                                <input type="number" id="age" name="age" readonly
                                    value="{{ old('age') }}"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50 cursor-not-allowed">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="tel" id="contact_number" name="contact_number"
                                    ...
                                    pattern="09\d{9}"
                                    maxlength="11"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('contact_number') border-red-500 @enderror"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Optional. Used for prenatal reminders and follow-up notifications.</p>
                                @error('email')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Civil Status <span class="text-red-500">*</span></label>
                                <select name="civil_status" class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('civil_status') border-red-500 @enderror">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="philhealth_member" name="philhealth_member" class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="para" name="para"
                                    value="{{ old('para', 0) }}"
                                    min="0"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('para') border-red-500 @enderror"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input type="date" id="lmp" name="lmp"
                                    value="{{ old('lmp') }}"
                                    max="{{ date('Y-m-d') }}"
                                    class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-[#55B85A] focus:border-[#55B85A] transition @error('lmp') border-red-500 @enderror">
                                <span class="error-message text-red-500 text-xs mt-1 hidden"></span>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" id="submitBtn"
                            class="px-6 py-2 bg-[#55B85A] text-white rounded-lg text-sm font-medium hover:bg-[#4aa04c] transition shadow-sm">
                            Save Patient
                        </button>
                    </div>
                </form>
