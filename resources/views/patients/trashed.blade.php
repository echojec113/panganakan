                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-end gap-2">
                                            <form action="{{ route('patients.restore', $patient->id) }}" method="POST">
                                                @csrf
                                                <button type="button" onclick="confirmRestore(this)" class="inline-flex items-center gap-2 px-3 py-2 bg-green-600 text-white text-sm rounded-lg hover:bg-green-700 transition">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
