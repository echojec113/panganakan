<x-app-layout>
    <style>
        .edit-prenatal-visit-theme {
            ...
            --edit-primary-soft: #EDF5EC;
            --edit-page-soft: #F6F4EE;
            --edit-border: #E7E9E5;
            --edit-text: #19355F;
            --edit-muted: #657083;
        }

        .edit-prenatal-visit-theme [class~="hover:text-blue-600"]:hover {
            color: var(--edit-primary-hover);
        }

        .edit-prenatal-visit-theme [class~="text-blue-800"],
        .edit-prenatal-visit-theme [class~="text-blue-900"],
        .edit-prenatal-visit-theme [class~="text-blue-900/80"] {
            color: var(--edit-text);
        }

        .edit-prenatal-visit-theme [class~="text-blue-600"] {
            color: var(--edit-primary);
        }

        .edit-prenatal-visit-theme [class~="border-blue-100"],
        .edit-prenatal-visit-theme [class~="border-blue-200"] {
            border-color: #D8EBD6;
        }

        .edit-prenatal-visit-theme [class~="bg-blue-50"] {
            background-color: var(--edit-primary-soft);
        }

        .edit-prenatal-visit-theme [class~="bg-blue-50\\/50"] {
            background-color: rgba(237, 245, 236, 0.5);
        }

        .edit-prenatal-visit-theme [class~="focus:ring-blue-500"] {
            --tw-ring-color: var(--edit-primary);
        }

        .edit-prenatal-visit-theme [class~="focus:border-blue-500"]:focus {
            border-color: var(--edit-primary);
        }

        .edit-prenatal-visit-theme [class~="bg-blue-100"] {
            background-color: var(--edit-primary-soft);
        }

        .edit-prenatal-visit-theme [class~="bg-blue-600"] {
            background-color: var(--edit-primary);
        }

        .edit-prenatal-visit-theme [class~="hover:bg-blue-700"]:hover {
            background-color: var(--edit-primary-hover);
        }

        .edit-prenatal-visit-theme [class~="bg-gray-50"],
        .edit-prenatal-visit-theme [class~="bg-gray-100"] {
            background-color: var(--edit-page-soft);
        }

        .edit-prenatal-visit-theme [class~="border-gray-100"],
        .edit-prenatal-visit-theme [class~="border-gray-200"],
        .edit-prenatal-visit-theme [class~="border-gray-300"] {
            border-color: var(--edit-border);
        }

        .edit-prenatal-visit-theme [class~="text-gray-900"],
        .edit-prenatal-visit-theme [class~="text-gray-800"],
        .edit-prenatal-visit-theme [class~="text-gray-700"] {
            color: var(--edit-text);
        }

        .edit-prenatal-visit-theme [class~="text-gray-600"],
        .edit-prenatal-visit-theme [class~="text-gray-500"] {
