...
<style>
    ...
    .view-referral-theme [class~="bg-violet-50"] {
        background-color: #EDF5EC;
    }

    .view-referral-theme [class~="bg-violet-100"] {
        background-color: #D8EBD6;
    }

    .view-referral-theme [class~="border-violet-100"] {
        border-color: #D8EBD6;
    }

    .view-referral-theme [class~="text-violet-900"],
    .view-referral-theme [class~="text-violet-700"],
    .view-referral-theme [class~="text-violet-600"],
    .view-referral-theme [class~="text-violet-500"] {
        color: #367E4B;
    }

    .view-referral-theme [class~="border-gray-100"],
    .view-referral-theme [class~="border-gray-200"] {
        border-color: #E7E9E5;
    }

    .view-referral-theme [class~="bg-gray-50"] {
        background-color: #F6F4EE;
    }

    .view-referral-theme [class~="text-gray-900"],
    .view-referral-theme [class~="text-gray-800"],
    .view-referral-theme [class~="text-gray-700"] {
        color: #19355F;
    }

    .view-referral-theme [class~="text-gray-600"],
    .view-referral-theme [class~="text-gray-500"],
    .view-referral-theme [class~="text-gray-400"] {
        color: #657083;
    }

    .view-referral-theme [class~="hover:bg-gray-50"]:hover {
        background-color: #F6F4EE;
    }

    .view-referral-theme [class~="focus:ring-amber-500"] {
        --tw-ring-color: #55B85A;
    }

    .view-referral-theme [class~="focus:border-amber-500"]:focus {
        border-color: #55B85A;
    }

    #refuseModal.refusal-modal-theme [class~="border-gray-200"] {
        border-color: #E7E9E5;
    }

    #refuseModal.refusal-modal-theme [class~="text-gray-900"],
    #refuseModal.refusal-modal-theme [class~="text-gray-700"] {
        color: #19355F;
    }

    #refuseModal.refusal-modal-theme [class~="text-gray-600"],
    #refuseModal.refusal-modal-theme [class~="text-gray-500"],
    #refuseModal.refusal-modal-theme [class~="text-gray-400"] {
        color: #657083;
    }

    #refuseModal.refusal-modal-theme [class~="focus:ring-amber-500"] {
        --tw-ring-color: #55B85A;
    }
...
<div class="view-referral-theme min-h-screen bg-[#FCFBF8]">
...
@if($referral->status === 'Pending')
<div id="refuseModal" class="refusal-modal-theme fixed inset-0 z-50 hidden items-center justify-center bg-black/40 backdrop-blur-sm px-4 py-6">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
        ...
        <form method="POST" id="refuseForm">
            ...
            <textarea id="refusal-notes" name="refusal_notes" rows="3" required minlength="10" maxlength="2000"
                class="mt-1 w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 resize-y"
